...
\begin{document}
	...
	\end{equation}
	ここで$u\pr{-\lambda}$を$\pr{-\lambda}$周りにTaylor展開\footnote{$f(x+\epsilon) = f(x) + f'(x)\epsilon + f''(x)\frac{\epsilon^2}{2!}...$\\}します：
	\begin{align}
		u\pr{-\lambda} &= u\pr{0} -\lambda\frac{du}{dy} + \order{\epsilon^2}\\
